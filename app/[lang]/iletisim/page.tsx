...
export default async function IletisimPage({
  ...
  return (
    <>
      <section className="bg-navy-900 px-6 pt-32 pb-20" aria-labelledby="contact-heading">
            ...
            <dl className="mt-10 flex flex-col gap-6">
              <div className="flex gap-4">
                <dt className="flex-shrink-0">
                  <div className="flex h-10 w-10 items-center justify-center rounded-sm bg-navy-900 text-gold-500">
              ...
              <div className="flex gap-4">
                ...
                <dd className="text-sm">
                  <a href="mailto:lawfirmvgs@gmail.com" className="text-ink hover:text-gold-500 transition-colors">
                    lawfirmvgs@gmail.com
                  </a>
                  <p className="mt-1 text-xs text-slate">
                    {locale === 'en'
                      ? '⚠ Confirm the canonical email before launch.'
                      : '⚠ Yayın öncesinde kanonik e-posta teyit edilmelidir.'}
                  </p>
                </dd>
              </div>
            </dl>
